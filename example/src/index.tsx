...
import {BleModule, BleProtocol} from '@kafudev/react-native-ble';
...
export default class App extends Component {
  ...
  handleUpdateValue = (data) => {
    ...
    if(data && data.value) {
      // 数组转换成16进制字符串
      let value = global.BluetoothProtocol.bytes2Str(data.value)
  ...
  write = (index) => {
    ...
    console.log('Write text:', this.state.text)
    // 16进制字符串转换成数组
    let text = global.BluetoothProtocol.str2Bytes(this.state.text)
